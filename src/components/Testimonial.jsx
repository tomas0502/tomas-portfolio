  ...
  const testimonials = [
    {
      ...
      content: `Working with Tomas was seamless from day one. Not only did they deliver a full-stack solution ahead of schedule, but they also communicated clearly throughout the project. It's rare to find a developer who understands both the tech and the business side so well`,
      rating: 5,
    ...
    },
    {
      ...
      content: `From wireframes to deployment, Tomas owned the entire stack with confidence and creativity. The final product is fast, reliable, and looks incredible. I wouldn't hesitate to work with them again.`,
      rating: 5,
        ...
        >
          <motion.div className="text-center" variants={itemVariants}>
            <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-2xl bg-primary/10 border border-primary/20 mb-6 transition-all duration-500 hover:bg-primary/15 hover:scale-105 group cursor-pointer">
              ...
              <span className="text-sm sm:text-base font-semibold text-primary tracking-wide">CLIENT FEEDBACK</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6">
              <span className="block text-primary animate-pulse">What people say</span>
            </h1>
            <motion.p
              ...
              {visibleTestimonials.map((testimonial) => (
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <p className="text-base sm:text-lg text-muted-foreground mb-4 sm:mb-6 flex-1 text-left">
                      {testimonial.content}
                    </p>
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="flex items-center gap-3 sm:gap-4 mt-3 sm:mt-4">
                        ...
                        <div>
                          <p className="font-medium text-sm sm:text-base text-left">{testimonial.name}</p>
